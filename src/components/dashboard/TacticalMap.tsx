...
export default function TacticalMap() {
    const { nodes, threatLevel } = useMqtt();
                ...
                <div className="col-span-1 bg-black/40 border border-green-500/20 rounded-xl p-6 relative overflow-hidden group hover:border-green-500/40 transition-colors">
                    ...
                    <div className="space-y-4 font-mono text-sm">
                        ...
                        <div className="flex justify-between border-b border-white/10 pb-2">
                            ...
                            <span className="text-white">04:22:19</span>
                        </div>
                        <div className="flex justify-between border-b border-white/10 pb-2">
                            <span className="text-neutral-400">AI MODEL</span>
                            <span className="text-purple-400">Quantized TFLite (v2)</span>
                        </div>

                        <div className="pt-4">
                            <div className="text-xs text-neutral-500 mb-1">PROBABILITY OF ATTACK</div>
                            <div className="w-full bg-white/10 h-4 rounded-full overflow-hidden">
                                <div
                                    className={`h-full transition-all duration-300 ${threatLevel === 'CRITICAL' ? 'bg-red-500 w-full' : 'bg-green-500 w-[5%]'}`}
                                />
                            </div>
                        </div>
                    </div>
